...
const shared_ini_file_loader_1 = __webpack_require__(24842);
const node_fs_1 = __webpack_require__(73024);
const fromWebToken_1 = __webpack_require__(21362);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(50337)));
...
var fromTokenFile = __webpack_require__(53178);
var fromWebToken = __webpack_require__(21362);
